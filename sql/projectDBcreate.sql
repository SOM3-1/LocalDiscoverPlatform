...
--INSERT INTO Fall24_S003_T8_Bookings (  Booking_ID, Traveler_ID, Experience_ID, Date_Of_Booking, Experience_Date, Amount_Paid, Booking_Status_ID, Booking_Method_ID, Payment_Status_ID ) VALUES ('B12346', 'T00001', 'E00001', TO_DATE('2024-11-01', 'YYYY-MM-DD'), TO_DATE('2024-10-31', 'YYYY-MM-DD'), 200.00, 'CONFIRMED', 'ONLINE', 'PENDING');
...
BEGIN
    ...
    FROM Fall24_S003_T8_Booking_Status 
