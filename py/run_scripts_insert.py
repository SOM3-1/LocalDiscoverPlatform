...
scripts = ['insert_lookup_tables.py', 'insert_travellers.py', 'insert_groups.py', 'insert_service_providers.py', 'insert_expereinces.py', 'insertBookings.py', 'insertRatings.py'] 
