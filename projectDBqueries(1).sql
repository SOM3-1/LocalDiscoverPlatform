...
-- Step 8: Change booking dates for selected bookings to a specific month and year
BEGIN
    DBMS_OUTPUT.PUT_LINE('Updating booking dates for selected bookings...');
    UPDATE Fall24_S003_T8_Bookings
    SET Date_Of_Booking = TO_DATE('2024-08-15', 'YYYY-MM-DD')
    WHERE Booking_ID IN ('B00005', 'B00009', 'B00012');
    DBMS_OUTPUT.PUT_LINE('Booking dates updated for B00005, B00009, B00012.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error in updating booking dates: ' || SQLERRM);
END;
/
...
BEGIN
    ...
    INSERT INTO Fall24_S003_T8_Bookings (Booking_ID, Traveler_ID, Experience_ID, Date_Of_Booking, Experience_Date, Amount_Paid, Booking_Status_ID, Booking_Method_ID, Payment_Status_ID)
    VALUES ('B10054', 'T00040', 'E00030', TO_DATE('2024-10-10', 'YYYY-MM-DD'), TO_DATE('2024-10-15', 'YYYY-MM-DD'), 2750.00, 'BS001', 'BM002', 'PS002');
    INSERT INTO Fall24_S003_T8_Bookings (Booking_ID, Traveler_ID, Experience_ID, Date_Of_Booking, Experience_Date, Amount_Paid, Booking_Status_ID, Booking_Method_ID, Payment_Status_ID)
    VALUES ('B10055', 'T00040', 'E00016', TO_DATE('2024-09-20', 'YYYY-MM-DD'), TO_DATE('2024-09-25', 'YYYY-MM-DD'), 2500.00, 'BS001', 'BM001', 'PS002');
...
-- Step 14: Reduce `Amount_Paid` for `T00013` to decrease their `Average_Spend`
BEGIN
    DBMS_OUTPUT.PUT_LINE('Reducing Amount_Paid for T00013...');
    UPDATE Fall24_S003_T8_Bookings
    SET Amount_Paid = 1200.00
    WHERE Booking_ID = 'B00043' AND Traveler_ID = 'T00013';
    DBMS_OUTPUT.PUT_LINE('Amount_Paid for T00013 updated to reduce Average_Spend.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error in updating Amount_Paid for T00013: ' || SQLERRM);
END;
/
