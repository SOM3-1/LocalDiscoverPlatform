...
try:
    ...
    logger.info(f"Generating {num_groups} groups (5% of travelers).")

    # Step 4: Generate fake group data
    group_data = []
    selected_leaders = random.sample(traveler_ids, num_groups)  # Randomly choose leaders

    with open("group_insert_statements.txt", "w") as file:
        # Write group insert statements in INSERT ALL format
        ...
        for i in range(num_groups):
            ...
            # Write each group's data as an INTO clause
            file.write(f"INTO Fall24_S003_T8_Groups (Group_ID, Group_Name, Group_Leader_T_ID, Group_Type_ID) "
                       f"VALUES ('{group_id}', '{group_name}', '{group_leader}', '{group_type_id}')\n")

        file.write("SELECT * FROM dual;\n\nCOMMIT;\n\n")  # Complete the INSERT ALL statement for groups
        ...
        # Step 5: Assign travelers to the groups
        ...
        file.write("INSERT ALL\n")  # Start INSERT ALL for group members
        ...
        for group_id, _, leader_id, _ in group_data:
            ...
            if potential_members:
                ...
                for t_id in selected_travelers:
                    ...
                    # Write each member's data as an INTO clause
                    file.write(f"INTO Fall24_S003_T8_Group_Members (Group_ID, T_ID) VALUES ('{group_id}', '{t_id}')\n")

        file.write("SELECT * FROM dual;\n\nCOMMIT;\n\n")  # Complete the INSERT ALL statement for group members
